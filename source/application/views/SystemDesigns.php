  ...
  <div class="maincell" id="maincellID"> <!-- Main content for this page -->
  	...
  	<div id="sidebarID" style="display:none;">
  		<div class="sidebar">
  			<nav>
  				<ul>
  					<li class="cross"><a class="cross" href="<?php echo base_url();?>SystemController">&times;</a></li><br>
	...
	<div class="pagination">
		...
		<a class="activePagination" href="<?php echo base_url();?>SystemController">1</a>
		...
		<a href="<?php echo base_url();?>SystemController2">&raquo;</a>
	</div>
